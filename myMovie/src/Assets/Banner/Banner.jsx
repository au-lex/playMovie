    ...
    <div className='banner'>
      <div className='banner__content'>
        ...
        <h2 className='movie__overview'>
          John Wick is onn the run after killling a member of the international assassins' guild, and with a $14 million price tag on his head, he is the target of hit men and women everywhere.
        </h2>
